    ...
    <div className="flex flex-col w-64 bg-[#f0f4f8] dark:bg-gray-900 h-dvh border-r border-gray-200 dark:border-gray-700">
      ...
      <div className="flex flex-col space-y-4 px-6 py-10 mt-6 flex-grow">
        ...
        <div>
          ...
          {isMoreOpen && (
            <div className=" flex flex-col mt-2 space-y-2 bg-gray-50 dark:bg-gray-800 rounded-lg shadow-lg">
              <Link
                to="/transactions"
                className="flex items-center text-gray-600 hover:text-indigo-700 dark:text-white dark:hover:hover:text-indigo-500 py-2 px-4 rounded-lg  "
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
              ...
              <Link
                to="/categories"
                className="flex items-center text-gray-600 hover:text-indigo-700 dark:text-white dark:hover:text-indigo-500 py-2 px-4 rounded-lg "
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
